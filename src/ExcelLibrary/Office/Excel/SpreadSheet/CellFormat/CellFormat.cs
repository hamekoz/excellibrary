...
namespace ExcelLibrary.SpreadSheet
{
	public class CellFormat
	{
		...
		/// <summary>
		/// Format the DateTime with: "YYYY-MM-DD HH:mm:ss" e.g: 2009-02-18
		/// </summary>
		public static readonly CellFormat DateTime = new CellFormat (CellFormatType.DateTime, @"YYYY\-MM\-DD HH:mm:ss");
